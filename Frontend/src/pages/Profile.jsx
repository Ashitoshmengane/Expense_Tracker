...
const Profile = ({ onUpdateProfile, onLogout }) => {
  ...
  const handleCacelEdit = useCallback(()=>{
    setTempUser(user);
    setEditMode(false);
                ...
                <div className={profileStyles.card}>
                    ...
                    {editMode ? (
                        <div className=' space-y-4'>
                            <div>
                                <label htmlFor="" className={profileStyles.label}>Full Name</label>
                                <input type="text" name="name" id=""  value={tempUser.name}
                                onChange={handleInputChange} className={profileStyles.input} disabled ={loading}/>
                            </div>

                             <div>
                                <label htmlFor="" className={profileStyles.label}>Email Address</label>
                                <input type="email" name="email" id=""  value={tempUser.email}
                                onChange={handleInputChange} className={profileStyles.input} disabled ={loading}/>
                            </div>
                            ...
                            <div className=' flex gap-3 pt-4'>
                                ...
                                <button onClick={handleCacelEdit} className={profileStyles.buttonSecondary}
                                disabled={loading}>
                                    Cancel
                                </button>
